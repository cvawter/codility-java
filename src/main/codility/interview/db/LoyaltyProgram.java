package main.codility.interview.db;
...
public class LoyaltyProgram {
    ...
    public static List<LogEntry> parseLogFile(File file) throws Exception {
        try (FileInputStream fis = new FileInputStream(file)) {
            return parseLogStream(fis);
        }
    }

    public static List<LogEntry> parseLogStream(InputStream in) throws Exception {
